...
class RotatePanel:
    ...
    def build(self, parent):
        ...
        run_button(parent, "Run", self.execute_rotate).pack(pady=10)
    ...
    def execute_rotate(self):
        ...
        try:
            ...
            output_path = rotate_pdf(
                self.pdf_file, self.entry_pages.get(), degrees, self.output_folder_picker.folder
            )
